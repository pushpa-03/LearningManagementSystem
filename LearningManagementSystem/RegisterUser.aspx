...
<head runat="server">
    ...
    <style>
        body { background: url('assets/images/bgImg.jpeg') no-repeat center center fixed; background-size: cover; }
        .signup-card { height: 85vh; max-height: 720px; display: flex; flex-direction: column; }
        .signup-body { overflow-y: auto; flex: 1; padding-right: 4px; }
    </style>
</head>
<body>
<form runat="server">
                ...
                <div class="bg-white rounded-4 shadow-sm p-4 signup-card ">
                    ...
                    <div class="signup-body">
                        ...
                        <div class="mb-3 position-relative">
                            ...
                            <asp:TextBox ID="txtConfirm" runat="server" TextMode="Password" CssClass="form-control form-control-lg"  Placeholder="••••••••" />
                            <i class="fas fa-lock input-icon"></i>
                        </div>
                    </div>
